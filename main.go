...
func main() {
	s := jsStringReturn()
	println("go: jsStringReturn", s)
	jsStringParam("🧵")
}

//export goStringParam
func goStringParam(s string) {
	println("go: goStringParam", s)
}

//export goStringReturn
// func goStringReturn() string {
//   return "???"
//}

func jsStringReturn() string {
	return getStringFromAddr(jsStringReturnEncoded())
}

//export jsStringReturnEncoded
func jsStringReturnEncoded() float64

//export jsStringParam
func jsStringParam(string)

// alloc pre-allocates memory used in string passing.
//
//export alloc
